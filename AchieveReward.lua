...
local AchieveReward= {
  [1]={BaseID=1,NameID=2610001,AchievePointCost=10,DescID=2620001,Rank=RankType.RT_White,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_RoleExp,RewardValueB=0,RewardValueC=2500,Sequence=1,},
  [2]={BaseID=2,NameID=2610002,AchievePointCost=25,DescID=2620002,Rank=RankType.RT_White,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_RoleExp,RewardValueB=0,RewardValueC=2500,Condition=1,Sequence=2,},
  [3]={BaseID=3,NameID=2610003,DescID=2620003,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_RoleExp,RewardValueB=0,RewardValueC=2500,Condition=2,Sequence=3,},
  [4]={BaseID=4,NameID=2610005,AchievePointCost=10,DescID=2620005,Rank=RankType.RT_White,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_MartialExp,RewardValueB=0,RewardValueC=5000,Sequence=5,},
  [5]={BaseID=5,NameID=2610006,AchievePointCost=25,DescID=2620006,Rank=RankType.RT_White,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_MartialExp,RewardValueB=0,RewardValueC=5000,Condition=4,Sequence=6,},
  [6]={BaseID=6,NameID=2610007,DescID=2620007,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_MartialExp,RewardValueB=0,RewardValueC=5000,Condition=5,Sequence=7,},
  ...
  [16]={BaseID=16,NameID=2610036,AchievePointCost=25,DescID=2620036,Rank=RankType.RT_White,RewardType=AchieveRewardType.ARD_BagNum,RewardValueA="周目奖励",RewardValueB=20,Sequence=36,},
  ...
  [48]={BaseID=48,NameID=2610004,AchievePointCost=100,DescID=2620004,Rank=RankType.RT_Blue,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_RoleExp,RewardValueB=0,RewardValueC=2500,Condition=3,Sequence=4,},
  [49]={BaseID=49,NameID=2610008,AchievePointCost=100,DescID=2620008,Rank=RankType.RT_Blue,RewardNavType=AchieveRewardNavType.ARNT_GrowSpeed,RewardType=AchieveRewardType.ARD_MartialExp,RewardValueB=0,RewardValueC=5000,Condition=5,Sequence=8,},
