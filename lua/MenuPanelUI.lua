...
function MenuPanelUI:Init()
	...
	self.comFileBtn =  self:FindChildComponent(self._gameObject,"menuBtnPanel/Panel/FileButton","Button")
	...
	self.comFileUIAction =   self.comFileBtn.gameObject:GetComponent("LuaUIAction")
	...
	SetUIActionHandle(self.comFileUIAction)
